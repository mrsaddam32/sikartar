          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  ...
                  <p class="mb-0">Enter your email and password to sign in</p>
                    @if (session()->has('success'))
                      <div class="alert alert-success alert-dismissible text-white fw-bold fade show mt-3" role="alert">
                        {{ session('success') }}
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                      </div>
                    @elseif (session()->has('error'))
                      <div class="alert alert-danger alert-dismissible text-white fw-bold fade show mt-3" role="alert">
                        {{ session('error') }}
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                      </div>
                    @endif
                ...
                <div class="card-body">
                  <form action="{{ route('auth.authenticate') }}" role="form" method="post">
                    @csrf
                    <label>Email</label>
                    <div class="mb-3">
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    ...
                    <a href="{{ route('auth.register') }}" class="text-info text-gradient font-weight-bold">Register</a>
                  </p>
                </div>
              </div>
            </div>
